...
console.log(character_start);

//Delimitamos si es una letra
...
switch(isCharacterALetter(character_start)){
    ...
    case false: //Puede que sea un número o un caracter especial
            ...
            if (isNumber(character_start)) {
                ...
                console.log(`El string ${string} inicia con un número, el cual es ${character_start}`) 
            }else{//Tenemos a un caracter especial
                console.log(`El string ${string} inicia con un caracter especial, el cual es ${character_start}`) 
            }
            break;
}
